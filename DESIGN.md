...
- **Caption**: Inter 12px medium, 1.4 line height, 0.02em tracking. Shipping info, stock labels.
- **Overline**: Inter 11px bold, 1.2 line height, 0.09em tracking. Category tags, "handmade" badges (uppercase).
